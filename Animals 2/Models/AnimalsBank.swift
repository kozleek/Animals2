...
class AnimalsBank {
  ...
  init() {
    ...
    self.list.append(Animal(name: "Slon", image: "elephant", environment: .jungle))
    ...
    self.list.append(Animal(name: "Králík", image: "rabbit", environment: .farm))
    self.list.append(Animal(name: "Lev", image: "leo", environment: .jungle))
    self.list.append(Animal(name: "Gorila", image: "gorilla", environment: .jungle))
    self.list.append(Animal(name: "Jehně", image: "lamb", environment: .farm))
    ...
    self.list.append(Animal(name: "Kobyla", image: "horse", environment: .farm))
